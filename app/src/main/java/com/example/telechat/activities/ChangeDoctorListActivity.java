...
import com.example.telechat.adapters.DoctorChangeAdapter;
...
public class ChangeDoctorListActivity extends AppCompatActivity {
    ActivityDoctorListBinding binding;
    FirebaseDatabase database;
    ArrayList<Doctor> doctors;
    DoctorChangeAdapter adapter;
    ...
    private void initialize() {
        ...
        adapter = new DoctorChangeAdapter(ChangeDoctorListActivity.this, doctors);
